...
export default function Page(){
  ...
  <Header/>
  {console.log(tasks)}
  { tasks ? tasks.map((task) => <Task key={task.id} id={task.id} todo={task.todo} onDelete={deleteButtonHandler}/>) : null}
  <Button onClick={addButtonHandler} variant='contained'>Add</Button>
  <Footer/>
  </>
